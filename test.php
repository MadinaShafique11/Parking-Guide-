...
//to check that the button is selected or not
if(isset($_POST['submit'])){
	...
	$Mail=$_POST['Email'];
	$Pass=$_POST['pass2'];
		$sql_query="INSERT INTO alogin (`first-name`, `last-name`, `email`,`pass`) VALUES ('$first_name', '$last_name', '$Mail','$Pass')";
	mysql_query($sql_query);
		
	}/* passward check if  Fname */
	else{
		echo "<p style='color:white;'>password do not match </p>";
	}/* passward check else */
}
?>
    ...
    <div class="card card-register mx-auto mt-5" id="logincard">
      ...
      <div class="card-body">
        ...
        <div class="text-center">
          <a class="d-block small mt-3" href="login2.php">Login Page</a>
